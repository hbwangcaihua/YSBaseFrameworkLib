...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/hbwangcaihua/YSBaseFrameworkLib"
  ...
  s.author             = { "王才华" => "hbwangcaihua@163.com" }
  ...
  s.source       = { :git => "https://github.com/hbwangcaihua/YSBaseFrameworkLib", :tag => "#{s.version}" }
